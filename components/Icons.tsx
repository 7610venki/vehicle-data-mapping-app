...
export const CircleDotIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const BrainIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08.5.5 0 0 0-.8-.4A2.5 2.5 0 0 1 2.5 14.5a2.5 2.5 0 0 1 2.5-2.5.5.5 0 0 0 .5-.5V10A2.5 2.5 0 0 1 8 7.5a.5.5 0 0 0 .5-.5v-2A2.5 2.5 0 0 1 9.5 2Z" /><path d="M14.5 2a2.5 2.5 0 0 0-2.5 2.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08.5.5 0 0 1 .8-.4A2.5 2.5 0 0 0 21.5 14.5a2.5 2.5 0 0 0-2.5-2.5.5.5 0 0 1-.5-.5V10a2.5 2.5 0 0 0-2.5-2.5.5.5 0 0 1-.5-.5v-2A2.5 2.5 0 0 0 14.5 2Z" />
    </svg>
);
...
export const FolderOpenIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
        <path d="m6 14 1.45-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.55 6a2 2 0 0 1-1.94 1.5H4a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2" />
    </svg>
);
...
export const DatabaseZapIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
        <ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5V19A9 3 0 0 0 12 22A9 3 0 0 0 21 19V5"></path><path d="M3 12A9 3 0 0 0 12 15A9 3 0 0 0 21 12"></path><path d="M11 10l-3 6"></path><path d="M13 10l3 6"></path>
    </svg>
);
